<section id="home">
	...
	<div
		class="h-full w-full flex flex-col text-center items-center justify-center my-10 py-16 sm:py-32 md:flex-row md:space-x-4 md:text-left md:py-28"
	>
	...
	<!-- <div class="text-5xl pt-5 text-center">"this is where tech stack logos will go"</div> -->

	<div class="flex flex-row gap-4 mb-4 text-5xl pt-5 text-center">
